...
public static class FoodNameGenerator
{
...
"島唐辛子",
    ...
    [FunctionName("FoodNameGeneratorFunction")]
    public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequest req, ILogger log)
    {
        log.LogInformation("食べ物名生成開始");
        ...
        foreach(var food in FoodNameList.Select((val, idx) => (val, idx)))
        {
            ...
            {
                log.LogInformation($"{food.val}:成功:{food.idx + 1}/{FoodNameList.Count}");
            }
            else
            {
        ...
        return new OkObjectResult("OK牧場!");
    }
}
